...
// nav 导航栏
	...
	$(".lunbo").children(".left").on("mouseover",function(){
		$(".l_img").stop(true,false).fadeToggle("slow")
	
	})

	$(".lunbo").children(".right").on("mouseleave",function(){
		$(".r_img").stop(true,false).fadeToggle("slow")
